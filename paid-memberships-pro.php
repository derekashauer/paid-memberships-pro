...
require_once( PMPRO_DIR . '/adminpages/courses.php' );             		// load the Courses admin page.
...
require_once( PMPRO_DIR . '/adminpages/member-edit/pmpro-class-member-edit-panel-courses.php' );
